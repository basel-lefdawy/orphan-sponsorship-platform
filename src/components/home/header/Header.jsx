      ...
      <Grid container justifyContent="center" spacing={30}>
        ...
        <Grid item xs={12} md={4} textAlign="center">
          <Box sx={{ display: "flex", gap: 1 }}>
            ...
            <AccessibilityNewIcon sx={{ color: "white", fontSize: 30 }}> </AccessibilityNewIcon>
        ...
        <Grid item xs={12} md={4} textAlign="center">
          <Box sx={{ display: "flex", gap: 1 }}>
            ...
            <FaceIcon sx={{ color: "#fff", fontWeight: "bold", mb: 3 }}></FaceIcon>
          </Box>
        ...
        <Grid item xs={12} md={4} textAlign="center">
          <Box sx={{ display: "flex", gap: 1 }}>
            ...
            <VolunteerActivismIcon sx={{ color: "#fff", fontWeight: "bold", mb: 3 }}></VolunteerActivismIcon>
...
export default function Header() {
  ...
  return (
    ...
    <>
      <AppBar sx={{ backgroundColor: "#2e7d32", direction: "rtl" }}>
        <Toolbar>
      ...
      <section>
        ...
        <Grid container spacing={4} justifyContent="center">
          ...
          {orphansData.map((orphan) => (
            <Grid item xs={12} sm={6} md={4} key={orphan.id} sx={{ transition: "0.3s", "&:hover": { transform: "translateY(-20px)", cursor: "pointer" } }}>
              <OrphanCard
                orphan={orphan}
              />
            </Grid>
        ...
        <div>
          ...
          <Grid container spacing={4} justifyContent="center">
            {activities.map((activity) => (
              <Grid item xs={12} sm={6} md={4} key={activity.id} sx={{ transition: "0.3s", "&:hover": { transform: "translateY(-20px)", cursor: "pointer" } }}>
      ...
      <footer>
        <Box sx={{ bgcolor: "#f0f0f0", py: 3, direction: "rtl" }}>
          <Grid container justifyContent="space-around" alignItems="flex-start">
            ...
            <Grid item xs={12} md={3} sx={{ display: "flex", flexDirection: "column", alignItems: "flex-start", width: 200, height: 100 }}>
              ...
              <Box sx={{ mb: 3 }}>
                  <FaceIcon />
                  <Button sx={{ mt: -2 }} href="#text-buttons" color="success">الأيتام</Button>
                </Box>
              </Box>
        ...
        <Box sx={{ bgcolor: "#f0f0f0", display: "flex", justifyContent: "center" }}>2025 © جميع الحقوق محفوظة  </Box>
      </footer>
    </>
  )
